                            ...
                            <form class="p-4 md:p-5" action="{{ route('destinasi.store') }}" method="post"
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <input type="text" id="wisata" name="wisata"
                                            class="form-control @error('wisata') is-invalid @enderror"
                                            placeholder="Nama Wisata" value="{{ old('wisata') }}">
                                        @error('wisata')
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <select class="form-select @error('lokasi_id') is-invalid @enderror"
                                            name="lokasi_id" aria-label="Default select example">
                                    ...
                                    <div class="col-span-2">
                                        <input type="file" id="foto" name="foto"
                                            ...
                                            placeholder="Foro Wisata" value="{{ old('foto') }}">
                                        @error('foto')
                                            <span class="invalid-feedback" role="alert" style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="tiket" name="tiket"
                                                ...
                                                placeholder="Harga Tiket" value="{{ old('tiket') }}">
                                            @error('tiket')
                                                <span class="invalid-feedback" role="alert" style="color: red;">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                        ...
                        @foreach ($destinasis as $key => $destinasi)
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <img src="{{ asset('storage/' . $destinasi->foto) }}" width="60px"
                                            alt="gambar">
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <!-- Edit Modal toggle -->
                                        <button data-modal-target="editdata{{ $destinasi->id }}"
                                            data-modal-toggle="editdata{{ $destinasi->id }}"
                                        ...
                                        <!-- Edit Modal -->
                                        <div id="editdata{{ $destinasi->id }}" tabindex="-1" aria-hidden="true"
                                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            data-modal-hide="editdata{{ $destinasi->id }}"
                                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                                                    ...
                                                    <form class="p-4 md:p-5"
                                                        action="{{ route('destinasi.update', ['destinasi' => $destinasi->id]) }}"
                                                        ...
                                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                                            <div class="col-span-2">
                                                                ...
                                                                <input type="text" id="wisata" name="wisata"
                                                                    class="form-control @error('wisata') is-invalid @enderror"
                                                                    placeholder="wisata Destinasi"
                                                                    value="{{ old('destinasi', $destinasi->wisata) }}"
                                                            ...
                                                            <div class="col-span-2">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($genres as $genre)
                                                                        <option value="{{ $genre->id }}"
                                                                            {{ $destinasi->genre_id == $genre->id ? 'selected' : '' }}>
                                                                            {{ $genre->genre }}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-span-2">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($lokasis as $lokasi)
                                                                        <option value="{{ $lokasi->id }}"
                                                                            {{ $destinasi->lokasi_id == $lokasi->id ? 'selected' : '' }}>
                                                                            {{ $lokasi->lokasi }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="col-span-2">
                                                                ...
                                                                <br><img src="{{ asset('storage/' . $destinasi->foto) }}"
                                                                    width="350px" height="400"
                                                                    style="object-fit:cover" alt="gambar"><br>
                                                            </div>
                                                            ...
                                                            <div class="col-span-2">
                                                                ...
                                                                <input type="text" id="stok" name="stok"
                                                                    class="form-control @error('stok') is-invalid @enderror"
                                                                    placeholder="wisata stok"
                                                                    value="{{ old('stok', $destinasi->stok) }}"
                                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                    placeholder="Type product name">
                                                                @error('stok')
                                                                    <span class="invalid-feedback" role="alert"
                                        ...
                                        <form action="/destinasi/{{ $destinasi->id }}" method="post"
