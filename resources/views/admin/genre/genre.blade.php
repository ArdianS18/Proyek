                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" id="genre" name="genre"
                                            ...
                                            placeholder="Kategori Destinasi" value="{{ old('genre') }}"
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <!-- Edit Modal toggle -->
                                        <button data-modal-target="editdata{{ $genre->id }}"
                                            data-modal-toggle="editdata{{ $genre->id }}"
                                        ...
                                        <!-- Edit Modal -->
                                        <div id="editdata{{ $genre->id }}" tabindex="-1" aria-hidden="true"
                                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button" data-modal-hide="editdata{{ $genre->id }}"
                                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
