...
<head> <title>Kategori Destinasi</title> </head>
                ...
                <div id="tambahdata" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <!-- Modal body -->
                            <form class="p-4 md:p-5" action="{{ route('galeri.store') }}" method="post"
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <input type="file" id="galeri" name="galeri"
                                            ...
                                            placeholder="Foro Wisata" value="{{ old('galeri') }}">
                                        @error('galeri')
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <!-- Edit Modal toggle -->
                                        <button data-modal-target="editdata{{ $galeri->id }}"
                                            data-modal-toggle="editdata{{ $galeri->id }}"
                                        ...
                                        <!-- Edit Modal -->
                                        <div id="editdata{{ $galeri->id }}" tabindex="-1" aria-hidden="true"
                                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button" data-modal-hide="editdata{{ $galeri->id }}"
                                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                                                    ...
                                                    <form class="p-4 md:p-5"
                                                        action="{{ route('galeri.update', ['galeri' => $galeri->id]) }}"
                                                        ...
                                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                                            <div class="col-span-2">
                                                                ...
                                                                <input type="file"
                                                                    class="form-control form-select @error('galeri') is-invalid @enderror"
                                                                    name="galeri">
                                                                @error('galeri')
