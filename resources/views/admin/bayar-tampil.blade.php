                        ...
                        @foreach ($bayars as $key => $bayar)
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <button data-modal-target="lihat{{ $bayar->id }}"
                                            data-modal-toggle="lihat{{ $bayar->id }}"
                                        ...
                                        <!-- Edit Modal -->
                                        <div id="lihat{{ $bayar->id }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button" data-modal-hide="lihat{{ $bayar->id }}"
                                                                ...
                                                                <div class="col-span-2">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <p
                                                                                ...
                                                                                <strong>Atas Nama :
                                                                                </strong>{{ $bayar->tiket->atas_nama }}</p>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <p
                                                                                ...
                                                                                {{ number_format($bayar->totalharga, 0, ',', '.') }}
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <p
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                                                <strong>Bukti Foto : </strong></p>
                                                                            <br><img
                                                                                src="{{ asset('storage/' . $bayar->foto) }}"
                                                                                width="350px" alt="gambar"><br>
                                                                        </td>
                                                                    </tr>
