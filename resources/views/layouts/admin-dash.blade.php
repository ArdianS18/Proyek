...
<head>
    ...
    <title>SB Admin - Bootstrap Admin Template</title>
        ...
        <!-- Bootstrap Core CSS -->
        <link href="css/bootstrapmin1.css" rel="stylesheet">
    ...
    <style>
        .container-fluid {
            min-height: 600px; /* Atur tinggi minimum yang diinginkan */
        }
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Halaman Dashboard Admin</a>
            </div>
            <!-- Top Menu Items -->
