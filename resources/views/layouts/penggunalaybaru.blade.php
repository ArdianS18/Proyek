...
<html>
	...
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ asset('css/bootstrapbaru.css') }}">
	...
	<!-- Theme style  -->
	<link rel="stylesheet" href="{{asset('css/stylebaru.css')}}">
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url({{ asset('photo/bg.jpeg') }})">
