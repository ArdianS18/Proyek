    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto {{ request()->routeIs('staf.index') ? 'active' : '' }}"
                            href="/" href="#hero">Home</a></li>
                        ...
                        <div class="">
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center ms-3">
                                    ...
                                    <div class="z-100 hidden my-4 text-base bg-white divide-gray-100"
                                        id="dropdown-user">
                                        <ul role="none">
                                            <li>

                                                <button data-modal-target="editprofile{{ Auth::user()->id }}"
                                                    data-modal-toggle="editprofile{{ Auth::user()->id }}"
        ...
        <!-- Main modal -->
        <div id="editprofile{{ Auth::user()->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="p-4 md:p-5"
                        action="{{ route('editprofile.update', ['editprofile' => Auth::user()->id]) }}"
